...
<template>
  <main
    ...
    <div class="border-t-2 border-solid border-l-grey w-[600px] absolute mt-[135px]"></div>
    <div class="absolute ml-[550px] mt-[95px] ">
      <button
        class="border border-solid border-transparent rounded-full bg-purple w-[80px] h-[80px] flex items-center justify-center transform transition duration-200 ease-out hover:scale-125"
        @click="calculateDate"><img class="w-10 h-10" src="./assets/images/icon-arrow.svg" alt="arrow"></button>
    </div>
    <div class="fixed mt-[150px]">
      <div
        class="flex flex-col items-start w-[600px] h-[300px] mt-0 font-bold italic text-[98px] leading-none justify-center ">
        <div class="flex">
